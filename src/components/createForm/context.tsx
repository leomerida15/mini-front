...
import { currencie, fromInput, pInput, createFormPropsContext, InputsGenerate } from './interface';

export * from './interface';

const CreateFormContext: FC<createFormPropsContext> = ({
	Action,
	schema,
	sx,
	context,
	...
	const Input = (input: fromInput): InputsGenerate => {
		switch (input.type) {
			case 'select':
	...
	return (
		<Box
			...
			autoComplete='off'
			onSubmit={onSubmit}>
			{Context.inputs.map((item: fromInput, i: number): ReactElement => {
